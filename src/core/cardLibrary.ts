...
function basicCardFactory(id: number): BasicCard | null {
  ...
  switch (id) {
    ...
    case 6:
      ...
      card.register(
        ...
        [
          ...
          new CardAction(
            CardActionType.Flip,
            new AssetCandidates([stone.plus(log)])
          ),
        ],
        new AssetCandidates([fish.plus(fish)])
      );
      ...
      card.register(
        ...
        [
          new CardAction(
            CardActionType.Rotate,
            new AssetCandidates([log2.plus(stone2).plus(fish2)])
          ),
        ],
        new AssetCandidates([])
      );
    ...
    case 9:
      ...
      card.register(
        ...
        [
          ...
          new CardAction(
            CardActionType.Flip,
            new AssetCandidates([log2.plus(fish)])
          ),
        ],
    ...
    case 10:
      ...
      card.register(
        ...
        [
          new CardAction(
            CardActionType.Pay,
            new AssetCandidates([log, fish, stone])
          ),
        ],
    ...
    case 11:
      ...
      card.register(
        ...
        [
          new CardAction(
            CardActionType.Pay,
            new AssetCandidates([log2, fish2])
          ),
          new CardAction(CardActionType.Rotate, new AssetCandidates([fish])),
      ...
      card.register(
        ...
        [
          new CardAction(
            CardActionType.Pay,
            new AssetCandidates([fish2, stone2])
          ),
          new CardAction(
            CardActionType.Flip,
            new AssetCandidates([log.plus(fish)])
      ...
      card.register(
        ...
        [
          new CardAction(
            CardActionType.Pay,
            new AssetCandidates([log2, stone2])
          ),
          new CardAction(
            CardActionType.Rotate,
            new AssetCandidates([log.plus(fish)])
    ...
    case 12:
      ...
      card.register(
        ...
        [
          new CardAction(
            CardActionType.Rotate,
            new AssetCandidates([log.plus(fish).plus(stone2)])
          ),
          new CardAction(
            CardActionType.Flip,
            new AssetCandidates([log.plus(fish)])
      ...
      card.register(
        ...
        [
          ...
          new CardAction(
            CardActionType.Flip,
            new AssetCandidates([log2.plus(fish2).plus(stone2)])
          ),
        ],
        new AssetCandidates([log.plus(fish).plus(stone)])
      );
    ...
    case 14:
      ...
      card.register(CardStatus.BackUp, 3, 6, [], new AssetCandidates([]));
      card.register(
        CardStatus.BackDown,
        2,
        3,
    ...
    case 16:
      ...
      card.register(
        ...
        [
          new CardAction(
            CardActionType.Flip,
            new AssetCandidates([log2.plus(fish2).plus(stone2).plus(stone)])
          ),
        ],
        new AssetCandidates([])
      );
      card.register(CardStatus.BackUp, 3, 10, [], new AssetCandidates([]));
      card.register(
        CardStatus.BackDown,
        2,
        6,
        [
          new CardAction(
            CardActionType.Rotate,
            new AssetCandidates([
              log2.plus(log).plus(fish).plus(fish2).plus(stone2).plus(stone2),
            ])
          ),
        ],
        new AssetCandidates([])
